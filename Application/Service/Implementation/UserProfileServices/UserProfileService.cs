...
namespace Application.Service.Implementation.UserProfileServices;
...
public class UserProfileService : IUserProfileService
{
    ...
    {
        var result = new OperationResult<UserProfileResponseDto>();
        var userProfile = await _unitOfWork.UserProfileRepository.GetByIdAsync(identityUserId);
    ...
    public async Task<OperationResult<IEnumerable<UserProfileResponseDto>>> GetAllAsync()
    {
        ...
        var userProfiles = await _unitOfWork.UserProfileRepository.GetAll();
    ...
    public async Task<OperationResult<UserProfileResponseDto>> UpdateAsync(string id, UpdateUserProfileDto dto)
    {
        ...
        var existsEmailForOther = await _unitOfWork.UserProfileRepository.GetQuery()
