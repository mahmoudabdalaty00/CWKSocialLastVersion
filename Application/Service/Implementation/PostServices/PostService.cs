...
public class PostService : IPostService
{
    ...
    public PostService(UnitOfWork unitOfWork, IMapper mapper, IValidator<CreatePostDto> createValidator, IValidator<UpdatePostDto> updateValidator)
    {
    ...
    {
        var posts = await _unitOfWork.PostRepository.GetByIdAsync(userProfileId);
